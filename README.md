...
## File Structure
This is how the current file structure is set with descriptions of each part
```
/ios: iOS native code
/src: JavaScript source files
  /assets: all media files, fonts 
    /images: any images
  /components: React-native components, such buttons, lists, etc
  /configs: any configurations, routes
  /constants: constant variables into this file
  /screens: screens of the app, main page, questions, summary
